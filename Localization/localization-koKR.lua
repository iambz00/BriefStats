...
L["Usage"] =
[[|cffffd100사용 키워드|r (띄어쓰기 무시)
[기어스코어]  [기코]  [아이템레벨]  [템렙]  [숙련 퍼센트]  [숙련]  [숙련도]  [특화]  [특화도]
[공격력]  [데미지] |cffcccccc공격력 증가 %|r  [감소] [보스감소] |cffcccccc방어도 데미지 감소율(동렙 / 보스)|r
[방어도]  [회피]  [무막]  [방막]  [완방] |cffcccccc빗나감+무막+회피|r  [방합] |cffcccccc완방+방막|r
[근접/원거리 적중/치명/가속/전투력]  [근접/원거리 적중도/가속도]
[주문 적중/가속/관통]  [주문 적중도/가속도]  [치유]
|cffffe57f[신성]  [신성 극대]|r  |cffff7f00[화염]  [화염 극대]|r  |cff4cff4c[자연]  [자연 극대]|r
|cff7fffff[냉기]  [냉기 극대]|r  |cff7f7fff[암흑]  [암흑 극대]|r  |cffff7fff[비전]  [비전 극대]|r (극대=치명 혼용 가능)
[이동속도]=[이속]  [탄력]  [탄력도]  ]]
L["ARMOR"]      = { "방어도", "방어R" }
L["REDUCTION"]  = "감소"
L["BOSS"]       = "보스"
