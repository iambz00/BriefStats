...
GearScore module for BriefStats
	
    - Based on TacoTip GearScore module by kebabstorm
    - Which is based on original GearScoreLite by Mirrikat45 & others
--]]
...
local BRACKET_SIZE = 1000	-- For WotLK
...
function TT_GS:GetScore()
    ...
    if (guid) then
        ...
        if (IsReady and GearScore > 0 and ItemCount > 0) then
            return GearScore, LevelTotal/ItemCount
        end
    end
    return 0,0
end
